...
//             <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(16,185,129,0.18),transparent_45%),radial-gradient(circle_at_80%_75%,rgba(6,182,212,0.16),transparent_42%)]" />

//             <div className="relative z-10 mx-auto w-full max-w-4xl rounded-2xl border border-border/60 bg-card/80 p-8 backdrop-blur-md md:p-12">
//                 <p className="text-sm uppercase tracking-[0.22em] text-muted-foreground">ImRabo Web Intelligence</p>
//                 <h1 className="mt-4 text-4xl font-semibold leading-tight md:text-5xl">
//                     AI Brain + Memory + Automation
//                 </h1>
//                 <p className="mt-5 max-w-2xl text-base text-muted-foreground md:text-lg">
//                     A live AI control center with map context, floating intelligence panels, command console,
//                     and voice-driven interactions.
//                 </p>

//                 <div className="mt-8 flex flex-wrap items-center gap-3">
//                     <Button asChild size="lg">
//                         <Link href="/imrabo">Open Control Center</Link>
//                     </Button>
...
//                     <div className="rounded-lg border border-border/60 bg-background/40 p-3">Live map + ambient intelligence layer</div>
//                     <div className="rounded-lg border border-border/60 bg-background/40 p-3">Draggable AI panels + timeline</div>
//                     <div className="rounded-lg border border-border/60 bg-background/40 p-3">Voice + command console workflow</div>
//                 </div>
//             </div>
//         </div>
//     );
